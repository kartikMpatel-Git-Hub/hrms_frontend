import { GetInappropriatePosts, MarkPostInappropriate } from "@/api/PostService"
...
function InappropriatePosts() {
    ...
    const { data, isLoading } = useQuery({
        queryKey: ["hr-inappropriate-posts", paged],
        queryFn: () => GetInappropriatePosts(paged)
    })
    ...
    return (
        <div className="p-6">
            <div className="mb-6 flex justify-between items-start">
                <div>
                    <h1 className="text-3xl font-bold mb-2">Inappropriate Posts</h1>
                        ...
                        filteredPosts && filteredPosts.length > 0 ? (
                            <TableBody>
                                {filteredPosts.map((post) => (
                                    <InappropriatePostTableRow
                                        key={post.id}
                                        post={post}
                                        onView={handleViewPost}
                                        onToggleAppropriate={handleToggleAppropriate}
...
export default InappropriatePosts
